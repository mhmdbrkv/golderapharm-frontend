...
// Supervisor Plans (plans submitted by reps for approval)
export const mockSupervisorPlans: VisitPlan[] = [
  {
    id: "s1",
    title: "Week 45 - Riyadh East Territory",
    description: "Focus on hospital accounts and new doctor onboarding",
    planType: "WEEKLY",
    status: "PENDING",
    startDate: "2025-11-04",
    endDate: "2025-11-10",
    objectives: [
      "Visit 12 existing doctors",
      "Add 3 new doctor accounts",
      "Conduct product presentation at King Fahad Hospital",
    ],
    selectedDoctors: [],
    submittedDate: "2025-11-01",
    rep: {
  ...
  },
  {
    id: "s2",
    title: "November 2025 - Territory Expansion",
    description: "Expand coverage to new medical centers in Riyadh North",
    planType: "MONTHLY",
    status: "APPROVED",
    startDate: "2025-11-01",
    endDate: "2025-11-30",
    objectives: [
      "Complete 80 doctor visits",
      "Achieve 110% of sales target",
      "Launch new product line presentation",
      "Organize 2 medical education events",
    ],
    selectedDoctors: [],
    submittedDate: "2025-10-28",
    rep: {
  ...
  {
    id: "s3",
    title: "Q4 Territory Verification Plan",
    description: "Verify all doctor accounts and update database",
    planType: "MONTHLY",
    status: "APPROVED",
    startDate: "2025-11-01",
    endDate: "2025-11-15",
    objectives: [
      "Verify contact information for 100 doctors",
      "Update specialty and hospital affiliations",
      "Identify inactive accounts",
      "Add missing prescribing preferences",
    ],
    selectedDoctors: [],
    submittedDate: "2025-10-28",
    rep: {
...
// Supervisor's Own Plans (created by supervisor, need manager approval)
export const mockSupervisorOwnPlans: Plan[] = [
  {
    id: "sp1",
    title: "November 2025 - Team Performance Plan",
    description: "Focus on team development and target achievement",
    planType: "MONTHLY",
    status: "APPROVED",
    startDate: "2025-11-01",
    endDate: "2025-11-30",
    objectives: [
      "Achieve 95% team target",
      "Conduct 4 joint visits per rep",
      "Complete Q4 performance reviews",
      "Implement new CRM training",
    ],
    targetDoctors: 0,
    targetVisits: 0,
  ...
  {
    id: "sp2",
    title: "Q4 2025 - Regional Expansion Strategy",
    description: "Expand territory coverage and increase market share",
    planType: "MONTHLY",
    status: "PENDING",
    startDate: "2025-10-01",
    endDate: "2025-12-31",
    objectives: [
      "Open 3 new hospital accounts",
      "Increase regional sales by 15%",
      "Launch new product in all territories",
      "Train team on advanced selling techniques",
    ],
    targetDoctors: 0,
    targetVisits: 0,
